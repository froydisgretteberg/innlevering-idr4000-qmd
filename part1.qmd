...
library(readxl)
library(gt)
lac_data <- read_excel("~/Master i treningsfysiologi/RStudio/laktatterskel/data/lac_data.xlsx")
View(lac_data)
```
...
lac_data <- read_excel("~/Master i treningsfysiologi/RStudio/laktatterskel/data/lac_data.xlsx", na = "NA")
View(lac_data)
lac_data %>%
  filter(time == "pre") %>%
